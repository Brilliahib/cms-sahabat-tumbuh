        ...
        <div className="space-y-4 text-gray-700">
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>
              ...
              tombol &quot;Ucapkan&quot; untuk mendengar pengucapan kalimat
              tersebut.
            </li>
            <li>
              <strong>Klik Huruf:</strong> Anda juga dapat langsung mendengarkan
              pengucapan huruf dengan mengklik huruf yang tersedia.
            </li>
          </ol>
          <p>Selamat mencoba!</p>
        </div>
